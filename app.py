...
def seed_fixtures():
    ...
    fixtures = [
        ...
        (1,'Group Stage','A','Mexico','South Africa','2026-06-11','19:00','Estadio Azteca','Mexico City'),
        (2,'Group Stage','A','South Korea','Czech Republic','2026-06-12','02:00','Estadio Akron','Guadalajara'),
        (3,'Group Stage','B','Canada','Bosnia-Herzegovina','2026-06-12','19:00','BMO Field','Toronto'),
        (4,'Group Stage','D','United States','Paraguay','2026-06-13','01:00','SoFi Stadium','Los Angeles, CA'),
        (5,'Group Stage','B','Qatar','Switzerland','2026-06-13','19:00',"Levi's Stadium",'Santa Clara, CA'),
        (6,'Group Stage','C','Brazil','Morocco','2026-06-13','22:00','MetLife Stadium','East Rutherford, NJ'),
        (7,'Group Stage','C','Haiti','Scotland','2026-06-14','01:00','Gillette Stadium','Foxborough, MA'),
        (8,'Group Stage','D','Australia','Turkey','2026-06-14','04:00','BC Place','Vancouver'),
        (9,'Group Stage','E','Germany','Curaçao','2026-06-14','17:00','NRG Stadium','Houston, TX'),
        (10,'Group Stage','F','Netherlands','Japan','2026-06-14','20:00','AT&T Stadium','Arlington, TX'),
        (11,'Group Stage','E','Ivory Coast','Ecuador','2026-06-14','23:00','Lincoln Financial Field','Philadelphia, PA'),
        (12,'Group Stage','F','Sweden','Tunisia','2026-06-15','02:00','Estadio BBVA','Monterrey'),
        (13,'Group Stage','H','Spain','Cape Verde Islands','2026-06-15','16:00','Mercedes-Benz Stadium','Atlanta, GA'),
        (14,'Group Stage','G','Belgium','Egypt','2026-06-15','19:00','Lumen Field','Seattle, WA'),
        (15,'Group Stage','H','Saudi Arabia','Uruguay','2026-06-15','22:00','Hard Rock Stadium','Miami Gardens, FL'),
        (16,'Group Stage','G','Iran','New Zealand','2026-06-16','01:00','SoFi Stadium','Los Angeles, CA'),
        (17,'Group Stage','I','France','Senegal','2026-06-16','19:00','MetLife Stadium','East Rutherford, NJ'),
        (18,'Group Stage','I','Iraq','Norway','2026-06-16','22:00','Gillette Stadium','Foxborough, MA'),
        (19,'Group Stage','J','Argentina','Algeria','2026-06-17','01:00','Arrowhead Stadium','Kansas City, MO'),
        (20,'Group Stage','J','Austria','Jordan','2026-06-17','04:00',"Levi's Stadium",'Santa Clara, CA'),
        (21,'Group Stage','K','Portugal','Congo DR','2026-06-17','17:00','NRG Stadium','Houston, TX'),
        (22,'Group Stage','L','England','Croatia','2026-06-17','20:00','AT&T Stadium','Arlington, TX'),
        (23,'Group Stage','L','Ghana','Panama','2026-06-17','23:00','BMO Field','Toronto'),
        (24,'Group Stage','K','Uzbekistan','Colombia','2026-06-18','02:00','Estadio Azteca','Mexico City'),
        (25,'Group Stage','A','Czech Republic','South Africa','2026-06-18','16:00','Mercedes-Benz Stadium','Atlanta, GA'),
        (26,'Group Stage','B','Switzerland','Bosnia-Herzegovina','2026-06-18','19:00','SoFi Stadium','Los Angeles, CA'),
        (27,'Group Stage','B','Canada','Qatar','2026-06-18','22:00','BC Place','Vancouver'),
        (28,'Group Stage','A','Mexico','South Korea','2026-06-19','01:00','Estadio Akron','Guadalajara'),
        (29,'Group Stage','D','United States','Australia','2026-06-19','19:00','Lumen Field','Seattle, WA'),
        (30,'Group Stage','C','Scotland','Morocco','2026-06-19','22:00','Gillette Stadium','Foxborough, MA'),
        (31,'Group Stage','C','Brazil','Haiti','2026-06-20','00:30','Lincoln Financial Field','Philadelphia, PA'),
        (32,'Group Stage','D','Turkey','Paraguay','2026-06-20','03:00',"Levi's Stadium",'Santa Clara, CA'),
        (33,'Group Stage','F','Netherlands','Sweden','2026-06-20','17:00','NRG Stadium','Houston, TX'),
        (34,'Group Stage','E','Germany','Ivory Coast','2026-06-20','20:00','BMO Field','Toronto'),
        (35,'Group Stage','E','Ecuador','Curaçao','2026-06-21','00:00','Arrowhead Stadium','Kansas City, MO'),
        (36,'Group Stage','F','Tunisia','Japan','2026-06-21','04:00','Estadio BBVA','Monterrey'),
        (37,'Group Stage','H','Spain','Saudi Arabia','2026-06-21','16:00','Mercedes-Benz Stadium','Atlanta, GA'),
        (38,'Group Stage','G','Belgium','Iran','2026-06-21','19:00','SoFi Stadium','Los Angeles, CA'),
        (39,'Group Stage','H','Uruguay','Cape Verde Islands','2026-06-21','22:00','Hard Rock Stadium','Miami Gardens, FL'),
        (40,'Group Stage','G','New Zealand','Egypt','2026-06-22','01:00','BC Place','Vancouver'),
        (41,'Group Stage','J','Argentina','Austria','2026-06-22','17:00','AT&T Stadium','Arlington, TX'),
        (42,'Group Stage','I','France','Iraq','2026-06-22','21:00','Lincoln Financial Field','Philadelphia, PA'),
        (43,'Group Stage','I','Norway','Senegal','2026-06-23','00:00','MetLife Stadium','East Rutherford, NJ'),
        (44,'Group Stage','J','Jordan','Algeria','2026-06-23','03:00',"Levi's Stadium",'Santa Clara, CA'),
        (45,'Group Stage','K','Portugal','Uzbekistan','2026-06-23','17:00','NRG Stadium','Houston, TX'),
        (46,'Group Stage','L','England','Ghana','2026-06-23','20:00','Gillette Stadium','Foxborough, MA'),
        (47,'Group Stage','L','Panama','Croatia','2026-06-23','23:00','BMO Field','Toronto'),
        (48,'Group Stage','K','Colombia','Congo DR','2026-06-24','02:00','Estadio Akron','Guadalajara'),
        (49,'Group Stage','B','Switzerland','Canada','2026-06-24','19:00','BC Place','Vancouver'),
        (50,'Group Stage','B','Bosnia-Herzegovina','Qatar','2026-06-24','19:00','Lumen Field','Seattle, WA'),
        (51,'Group Stage','C','Morocco','Haiti','2026-06-24','22:00','Mercedes-Benz Stadium','Atlanta, GA'),
        (52,'Group Stage','C','Scotland','Brazil','2026-06-24','22:00','Hard Rock Stadium','Miami Gardens, FL'),
        (53,'Group Stage','A','Czech Republic','Mexico','2026-06-25','01:00','Estadio Azteca','Mexico City'),
        (54,'Group Stage','A','South Africa','South Korea','2026-06-25','01:00','Estadio BBVA','Monterrey'),
        (55,'Group Stage','E','Ecuador','Germany','2026-06-25','20:00','MetLife Stadium','East Rutherford, NJ'),
        (56,'Group Stage','E','Curaçao','Ivory Coast','2026-06-25','20:00','Lincoln Financial Field','Philadelphia, PA'),
        (57,'Group Stage','F','Tunisia','Netherlands','2026-06-25','23:00','Arrowhead Stadium','Kansas City, MO'),
        (58,'Group Stage','F','Japan','Sweden','2026-06-25','23:00','AT&T Stadium','Arlington, TX'),
        (59,'Group Stage','D','Turkey','United States','2026-06-26','02:00','SoFi Stadium','Los Angeles, CA'),
        (60,'Group Stage','D','Paraguay','Australia','2026-06-26','02:00',"Levi's Stadium",'Santa Clara, CA'),
        (61,'Group Stage','I','Norway','France','2026-06-26','19:00','Gillette Stadium','Foxborough, MA'),
        (62,'Group Stage','I','Senegal','Iraq','2026-06-26','19:00','BMO Field','Toronto'),
        (63,'Group Stage','H','Uruguay','Spain','2026-06-27','00:00','Estadio Akron','Guadalajara'),
        (64,'Group Stage','H','Cape Verde Islands','Saudi Arabia','2026-06-27','00:00','NRG Stadium','Houston, TX'),
        (65,'Group Stage','G','New Zealand','Belgium','2026-06-27','03:00','BC Place','Vancouver'),
        (66,'Group Stage','G','Egypt','Iran','2026-06-27','03:00','Lumen Field','Seattle, WA'),
        (67,'Group Stage','L','Panama','England','2026-06-27','21:00','MetLife Stadium','East Rutherford, NJ'),
        (68,'Group Stage','L','Croatia','Ghana','2026-06-27','21:00','Lincoln Financial Field','Philadelphia, PA'),
        (69,'Group Stage','K','Colombia','Portugal','2026-06-27','23:30','Hard Rock Stadium','Miami Gardens, FL'),
        (70,'Group Stage','K','Congo DR','Uzbekistan','2026-06-27','23:30','Mercedes-Benz Stadium','Atlanta, GA'),
        (71,'Group Stage','J','Jordan','Argentina','2026-06-28','02:00','AT&T Stadium','Arlington, TX'),
        (72,'Group Stage','J','Algeria','Austria','2026-06-28','02:00','Arrowhead Stadium','Kansas City, MO'),
        # ---- Knockout (no scores until groups finish) ----
        (73,'Round of 32',None,'TBD','TBD','2026-06-28','19:00','SoFi Stadium','Los Angeles, CA'),
        (74,'Round of 32',None,'TBD','TBD','2026-06-29','17:00','Gillette Stadium','Foxborough, MA'),
        (75,'Round of 32',None,'TBD','TBD','2026-06-29','20:30','Estadio BBVA','Monterrey'),
        (76,'Round of 32',None,'TBD','TBD','2026-06-30','01:00','NRG Stadium','Houston, TX'),
        (77,'Round of 32',None,'TBD','TBD','2026-06-30','17:00','MetLife Stadium','East Rutherford, NJ'),
        (78,'Round of 32',None,'TBD','TBD','2026-06-30','21:00','AT&T Stadium','Arlington, TX'),
        (79,'Round of 32',None,'TBD','TBD','2026-07-01','01:00','Estadio Azteca','Mexico City'),
        (80,'Round of 32',None,'TBD','TBD','2026-07-01','16:00','Mercedes-Benz Stadium','Atlanta, GA'),
        (81,'Round of 32',None,'TBD','TBD','2026-07-01','20:00',"Levi's Stadium",'Santa Clara, CA'),
        (82,'Round of 32',None,'TBD','TBD','2026-07-02','00:00','Lumen Field','Seattle, WA'),
        (83,'Round of 32',None,'TBD','TBD','2026-07-02','19:00','BMO Field','Toronto'),
        (84,'Round of 32',None,'TBD','TBD','2026-07-02','23:00','SoFi Stadium','Los Angeles, CA'),
        (85,'Round of 32',None,'TBD','TBD','2026-07-03','03:00','BC Place','Vancouver'),
        (86,'Round of 32',None,'TBD','TBD','2026-07-03','18:00','Hard Rock Stadium','Miami Gardens, FL'),
        (87,'Round of 32',None,'TBD','TBD','2026-07-03','22:00','Arrowhead Stadium','Kansas City, MO'),
        (88,'Round of 32',None,'TBD','TBD','2026-07-04','01:30','AT&T Stadium','Arlington, TX'),
        (89,'Round of 16',None,'TBD','TBD','2026-07-04','17:00','Lincoln Financial Field','Philadelphia, PA'),
        (90,'Round of 16',None,'TBD','TBD','2026-07-04','21:00','NRG Stadium','Houston, TX'),
        (91,'Round of 16',None,'TBD','TBD','2026-07-05','20:00','MetLife Stadium','East Rutherford, NJ'),
        (92,'Round of 16',None,'TBD','TBD','2026-07-06','00:00','Estadio Azteca','Mexico City'),
        (93,'Round of 16',None,'TBD','TBD','2026-07-06','19:00','AT&T Stadium','Arlington, TX'),
        (94,'Round of 16',None,'TBD','TBD','2026-07-07','00:00','Lumen Field','Seattle, WA'),
        (95,'Round of 16',None,'TBD','TBD','2026-07-07','16:00','Mercedes-Benz Stadium','Atlanta, GA'),
        (96,'Round of 16',None,'TBD','TBD','2026-07-07','20:00','BC Place','Vancouver'),
        (97,'Quarter-final',None,'TBD','TBD','2026-07-09','20:00','Gillette Stadium','Foxborough, MA'),
        (98,'Quarter-final',None,'TBD','TBD','2026-07-10','19:00','SoFi Stadium','Los Angeles, CA'),
        (99,'Quarter-final',None,'TBD','TBD','2026-07-11','21:00','Hard Rock Stadium','Miami Gardens, FL'),
        (100,'Quarter-final',None,'TBD','TBD','2026-07-12','01:00','Arrowhead Stadium','Kansas City, MO'),
        (101,'Semi-final',None,'TBD','TBD','2026-07-14','19:00','AT&T Stadium','Arlington, TX'),
        (102,'Semi-final',None,'TBD','TBD','2026-07-15','19:00','Mercedes-Benz Stadium','Atlanta, GA'),
        (103,'Third Place',None,'TBD','TBD','2026-07-18','21:00','Hard Rock Stadium','Miami Gardens, FL'),
        (104,'Final',None,'TBD','TBD','2026-07-19','19:00','MetLife Stadium','East Rutherford, NJ'),
    ]
    import datetime
...
def admin_panel():
    ...
    if request.method == 'POST':
        ...
        if action == 'delete_user':
            ...
            if ok:
                flash('Fixtures synced from worldcup26.ir!', 'success')
            else:
...
def sync_fixtures_from_api():
    """Fetch fixture data from worldcup26.ir and fill in match results."""
    ...
    for match in games:
        ...
        round_name = ROUND_MAP.get(match_type, 'Group Stage')
        group_name = match.get('group') if match_type == 'group' else None

        home_raw = match.get('home_team_name_en', '')
        away_raw = match.get('away_team_name_en', '')
    ...
    db.commit()
    logging.info(f"sync_fixtures: {len(updated)} matches synced from worldcup26.ir")
    return True
...
def admin_sync_fixtures():
    """Admin endpoint to sync fixture data from worldcup26.ir."""
    try:
        ok = sync_fixtures_from_api()
        if ok:
            flash('Fixtures synced from worldcup26.ir!', 'success')
        else:
            flash('Failed to sync fixtures (worldcup26.ir unreachable).', 'danger')
    except Exception as e:
